...
buttons[0].addEventListener("click", one_ten)
buttons[1].addEventListener("click", one_ten)
...
const eleven_twenty = () => {
  ...
  if (tbody.innerHTML.length > 0) {
    tbody.innerHTML = ""
    list.filter(listItem => {
      if (listItem.id > 10 && listItem.id <= 20) {
        const tr = document.createElement("tr")
        const td = document.createElement("td")
        const td1 = document.createElement("td")
        const td2 = document.createElement("td")
...
buttons[2].addEventListener("click", eleven_twenty)

const twentyOne_thirty = () => {

  if (tbody.innerHTML.length > 0) {
    tbody.innerHTML = ""
    list.filter(listItem => {
      if (listItem.id > 20 && listItem.id <= 30) {
        const tr = document.createElement("tr")
        const td = document.createElement("td")
        const td1 = document.createElement("td")
        const td2 = document.createElement("td")
...
buttons[3].addEventListener("click", twentyOne_thirty)


const thirtyOne_fourty = () => {

  if (tbody.innerHTML.length > 0) {
    tbody.innerHTML = ""
    list.filter(listItem => {
      if (listItem.id > 30 && listItem.id <= 40) {
        const tr = document.createElement("tr")
        const td = document.createElement("td")
        const td1 = document.createElement("td")
        const td2 = document.createElement("td")
...
buttons[4].addEventListener("click", thirtyOne_fourty)

const fourtyOne_fifty = () => {

  if (tbody.innerHTML.length > 0) {
    tbody.innerHTML = ""
    list.filter(listItem => {
      if (listItem.id > 40 && listItem.id <= 50) {
        const tr = document.createElement("tr")
        const td = document.createElement("td")
        const td1 = document.createElement("td")
        const td2 = document.createElement("td")
...
buttons[5].addEventListener("click", fourtyOne_fifty)

const fiftyOne_sixty = () => {

  if (tbody.innerHTML.length > 0) {
    tbody.innerHTML = ""
    list.filter(listItem => {
      if (listItem.id > 50 && listItem.id <= 60) {
        const tr = document.createElement("tr")
        const td = document.createElement("td")
        const td1 = document.createElement("td")
        const td2 = document.createElement("td")
...
buttons[6].addEventListener("click", fiftyOne_sixty)

const sixtyOne_seventy = () => {

  if (tbody.innerHTML.length > 0) {
    tbody.innerHTML = ""
    list.filter(listItem => {
      if (listItem.id > 60 && listItem.id <= 70) {
        const tr = document.createElement("tr")
        const td = document.createElement("td")
        const td1 = document.createElement("td")
        const td2 = document.createElement("td")
...
buttons[7].addEventListener("click", sixtyOne_seventy)

const seventyOne_eighty = () => {

  if (tbody.innerHTML.length > 0) {
    tbody.innerHTML = ""
    list.filter(listItem => {
      if (listItem.id > 70 && listItem.id <= 80) {
        const tr = document.createElement("tr")
        const td = document.createElement("td")
        const td1 = document.createElement("td")
        const td2 = document.createElement("td")
...
buttons[8].addEventListener("click", seventyOne_eighty)

const eightyOne_ninety = () => {

  if (tbody.innerHTML.length > 0) {
    tbody.innerHTML = ""
    list.filter(listItem => {
      if (listItem.id > 80 && listItem.id <= 90) {
        const tr = document.createElement("tr")
        const td = document.createElement("td")
        const td1 = document.createElement("td")
        const td2 = document.createElement("td")
...
buttons[9].addEventListener("click", eightyOne_ninety)

const ninetyOne_hundred = () => {

  if (tbody.innerHTML.length > 0) {
    tbody.innerHTML = ""
    list.filter(listItem => {
      if (listItem.id > 90 && listItem.id <= 100) {
        const tr = document.createElement("tr")
        const td = document.createElement("td")
        const td1 = document.createElement("td")
        const td2 = document.createElement("td")
...
buttons[10].addEventListener("click", ninetyOne_hundred)
buttons[11].addEventListener("click", ninetyOne_hundred)
